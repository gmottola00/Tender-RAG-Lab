...
with the generic chunking interfaces defined in quaerium.core.chunking.types.
"""
...
from quaerium.core.chunking.types import ChunkLike, TokenChunkLike
...
class TenderChunk:
    ...
    This implementation conforms to the ChunkLike Protocol from quaerium.core.chunking.types
...
class TenderTokenChunk:
    ...
    This implementation conforms to the TokenChunkLike Protocol from quaerium.core.chunking.types
